export class Modal {
	...
	buildModal(content){
		...
		this.modalWindow=this.createDomNode(this.modalWindow, 'div', 'modal_window');
	...
	appendModalElements(){
		this.overlay.appendChild(this.modalWindow);
	...
	closeModal(e){
		...
		if(classes.contains('modal_overlay')||classes.contains('modal_window')||classes.contains('modal__close-icon')){
