...
import './global.css';
import { addBrandClickHandler, addSearchClickHandler, addCardClickHandler, addResetSettingClickHandler, addCategoryClickHandler, addAgeClickHandler, addSaleClickHandler, filter } from './components/filter';
